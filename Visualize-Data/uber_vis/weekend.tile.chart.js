var margin_c2 = { top: 50, right: 0, bottom: 275, left: 30 },
    ...
    colors = ['#fff5eb','#fee6ce','#fdd0a2','#fdae6b','#fd8d3c','#f16913','#d94801','#a63603','#7f2704'], // thanks http://colorbrewer2.org/
    // days = ["Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"],
    days = ["Sa", "Su"],
    times = ["1a", "2a", "3a", "4a", "5a", "6a", "7a", "8a", "9a", "10a", "11a", "12a", "1p", "2p", "3p", "4p", "5p", "6p", "7p", "8p", "9p", "10p", "11p", "12p"];
    datasets = ["dataweekend.tsv"];
...
var heatmapChart = function(tsvFile) {
  ...
  function(error, data) {
    ...
    cards.enter().append("rect")
        ...
        .attr("y", function(d) { return (d.day - 6) * gridSize; })
        .attr("rx", 4)
        .attr("ry", 4)
