...
API_KEY = { "popular": "69c5e6dc4d0d83bfe08b99be67458f05:11:69247597",
            "article": "979b865ceda900cf68ca24f60f4b030d:18:69247597"}
...
# For test kind = 'viewed' and period = 1
def article_overview(kind, period):
    ...
    for el in data['results']:
        titles.append({el['section']: el['title']})
    # Populate urls list
    for el in results:
        all_media.append(el['media'][0]['media-metadata'])
    for el in all_media:
        for dic in el:
            if dic['format'] == 'Standard Thumbnail':
                urls.append(dic['url'])
...
def query_site(url, target, offset):
    ...
    r = requestqus.get(url, params = params)
